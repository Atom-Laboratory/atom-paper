...
Todo o código de teste, \textit{scripts} de medição e procedimentos de pré‑processamento foram versionados e disponibilizados no repositório do projeto para garantir reprodutibilidade, (Autor, 2025).
