...
Em suma, não existe uma "melhor linguagem" universal para o OpenCV; a escolha deve ser pautada pelo equilíbrio entre os requisitos não-funcionais de desempenho do sistema e os requisitos de negócio relacionados ao tempo de entrega, manutenibilidade do código e custo de desenvolvimento.