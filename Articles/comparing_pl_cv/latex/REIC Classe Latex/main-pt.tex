...
\begin{pchaves}
Visão computacional, bibliotecas, linguagens de programação, OpenCV, TensorFlow, YOLO, JavaCV, VisionWorks, BoofCV, OpenIMAJ, Halcon, SimpleCV
\end{pchaves}
...
\begin{materials}
  Os conjuntos de dados e softwares gerados e analisados durante o estudo atual estão disponíveis em \ldots'https://github.com/orgs/ATOM-Arm'.
\end{materials}
