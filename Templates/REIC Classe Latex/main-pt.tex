...
\title[Template da REIC 2025 para artigos em português]{Apresentação do template da REIC para 2025 - Versão para artigos em português}
\engtitle{\textcolor{engtitle}{Presenting the REIC template for 2025 - Version for works in Portuguese}}
