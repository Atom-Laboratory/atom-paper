...
A fundamentação teórica deste projeto sustenta-se na premissa da Quarta Revolução Industrial, definida por \citeonline{Schwab2016} como a fusão de tecnologias que atenuam as linhas entre as esferas física, digital e biológica. Para o autor, a evolução dos sistemas ciberfísicos é central nesta transição, exigindo que máquinas operem com níveis crescentes de autonomia e integração. Nesse contexto, a convergência entre robótica, visão computacional e inteligência artificial reflete o impacto sistêmico descrito por Schwab, conforme detalhado nas frentes de pesquisa a seguir.

\subsection*{Visão Computacional Aplicada e Sensoriamento}
\addcontentsline{toc}{subsection}{Visão Computacional Aplicada e Sensoriamento}
...
\subsection*{Robótica e Controle Assistido por Visão}
\addcontentsline{toc}{subsection}{Robótica e Controle Assistido por Visão}
...
\subsection*{Infraestrutura IoT, Segurança e Inteligência de Dados}
\addcontentsline{toc}{subsection}{Infraestrutura IoT, Segurança e Inteligência de Dados}
