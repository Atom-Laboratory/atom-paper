...
2. Arquitetura de Visão e Aquisição de Dados 
& & x & x & & & & & & \\ \hline

3. Modelagem, Impressão 3D e Montagem da Base Cinemática (2 DoF) 
& x & x & x & & & & & & \\ \hline

4. Treinamento, Otimização e Inferência Embarcada (Edge AI) 
& & & & x & x & x & & & \\ \hline

5. Integração Visão–Controle e Cinemática Inversa 
& & & & & x & x & & & \\ \hline

6. Testes de Validação e Coleta de Métricas Experimentais 
& & & & & & x & x & & \\ \hline

7. Coleta e Curadoria de Dataset 
& & & & & & & x & x & \\ \hline
